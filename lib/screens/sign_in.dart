...
import 'package:yourmood/screens/sign_up.dart';
                    ...
                    child: MaterialButton(
                      ...
                      onPressed: () async{
                          if(emailController.text.isNotEmpty && passwordController.text.isNotEmpty)
                            {
                              Mng db = Mng();
                              bool ok = await db.credentialsValidation(emailController.text, passwordController.text);
                              if(ok)
                                {
